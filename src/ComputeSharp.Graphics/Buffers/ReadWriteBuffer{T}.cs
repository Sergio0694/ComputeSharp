...
namespace ComputeSharp.Graphics.Buffers
{
    ...
    public sealed class ReadWriteBuffer<T> : Buffer<T> where T : unmanaged
    {
        /// <summary>
        ...
        internal ReadWriteBuffer(GraphicsDevice device, int size) : base(device, size, HeapType.Default) { }
