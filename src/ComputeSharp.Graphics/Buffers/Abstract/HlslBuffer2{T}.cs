...
namespace ComputeSharp.Graphics.Buffers.Abstract
{
    ...
    public abstract class HlslBuffer2<T> : Buffer2<T> where T : unmanaged
    {
        /// <summary>
        /// Creates a new <see cref="HlslBuffer2{T}"/> instance with the specified parameters
        /// </summary>
        ...
        private protected HlslBuffer2(GraphicsDevice2 device, int size, int sizeInBytes, BufferType bufferType)
            : base(device, size, sizeInBytes, bufferType)
        {
        }

        /// <summary>
        /// Reads the contents of the current <see cref="HlslBuffer2{T}"/> instance and returns an array
        /// </summary>
        ...
        /// <summary>
        /// Reads the contents of the current <see cref="HlslBuffer2{T}"/> instance in a given range and returns an array
        /// </summary>
        ...
        /// <summary>
        /// Reads the contents of the current <see cref="HlslBuffer2{T}"/> instance and writes them into a target <see cref="Span{T}"/>
        /// </summary>
        /// <param name="span">The input <see cref="Span{T}"/> to write data to</param>
        public void GetData(Span<T> span) => GetData(span, 0, Size);

        /// <summary>
        /// Reads the contents of the specified range from the current <see cref="HlslBuffer2{T}"/> instance and writes them into a target <see cref="Span{T}"/>
        /// </summary>
        /// <param name="span">The input <see cref="Span{T}"/> to write data to</param>
        /// <param name="offset">The offset to start reading data from</param>
        /// <param name="count">The number of items to read</param>
        ...
        /// <summary>
        /// Writes the contents of a given <typeparamref name="T"/> array to the current <see cref="HlslBuffer2{T}"/> instance
        /// </summary>
        ...
        /// <summary>
        /// Writes the contents of a given <typeparamref name="T"/> array to a specified area of the current <see cref="HlslBuffer2{T}"/> instance
        /// </summary>
        /// <param name="array">The input <typeparamref name="T"/> array to read data from</param>
        ...
        /// <summary>
        /// Writes the contents of a given <see cref="ReadOnlySpan{T}"/> to the current <see cref="HlslBuffer2{T}"/> instance
        /// </summary>
        ...
        /// <summary>
        /// Writes the contents of a given <see cref="ReadOnlySpan{T}"/> to a specified area of the current <see cref="HlslBuffer2{T}"/> instance
        /// </summary>
        /// <param name="span">The input <see cref="ReadOnlySpan{T}"/> to read data from</param>
        /// <param name="offset">The offset to start writing data to</param>
        /// <param name="count">The number of items to write</param>
        ...
        /// <summary>
        /// Writes the contents of a given <see cref="HlslBuffer2{T}"/> to the current <see cref="HlslBuffer2{T}"/> instance
        /// </summary>
        /// <param name="buffer">The input <see cref="HlslBuffer2{T}"/> to read data from</param>
        public abstract void SetData(HlslBuffer2<T> buffer);

        /// <summary>
        /// Writes the contents of a given <see cref="HlslBuffer2{T}"/> to the current <see cref="HlslBuffer2{T}"/> instance, using a temporary CPU buffer
        /// </summary>
        /// <param name="buffer">The input <see cref="HlslBuffer2{T}"/> to read data from</param>
        protected void SetDataWithCpuBuffer(HlslBuffer2<T> buffer)
        {
