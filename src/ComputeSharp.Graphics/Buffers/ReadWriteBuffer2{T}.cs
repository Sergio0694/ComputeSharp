...
namespace ComputeSharp
{
    ...
    public sealed class ReadWriteBuffer2<T> : HlslStructuredBuffer2<T>
        where T : unmanaged
    {
        /// <summary>
        /// Creates a new <see cref="ReadWriteBuffer2{T}"/> instance with the specified parameters
        /// </summary>
        ...
        internal ReadWriteBuffer2(GraphicsDevice2 device, int size)
            : base(device, size, BufferType.ReadWrite)
        {
        }
