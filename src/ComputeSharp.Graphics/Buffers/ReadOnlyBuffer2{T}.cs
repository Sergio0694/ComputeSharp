...
namespace ComputeSharp
{
    ...
    public sealed class ReadOnlyBuffer2<T> : HlslStructuredBuffer2<T>
        where T : unmanaged
    {
        /// <summary>
        /// Creates a new <see cref="ReadOnlyBuffer2{T}"/> instance with the specified parameters
        /// </summary>
        /// <param name="device">The <see cref="GraphicsDevice"/> associated with the current instance</param>
        /// <param name="size">The number of items to store in the current buffer</param>
        internal ReadOnlyBuffer2(GraphicsDevice2 device, int size)
