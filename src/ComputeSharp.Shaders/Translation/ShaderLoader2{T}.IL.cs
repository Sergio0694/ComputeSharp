...
{
    /// <inheritdoc cref="ShaderLoader2{T}"/>
    internal sealed partial class ShaderLoader2<T>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets a new <see cref="DispatchData2"/> instance with all the captured data for the current shader instance.
        /// </summary>
        ...
        public DispatchData2 GetDispatchData(in T shader, int x, int y, int z)
        {
            ...
            return new DispatchData2(resources, this.totalResourceCount, variables, this.totalVariablesByteSize);
        }
