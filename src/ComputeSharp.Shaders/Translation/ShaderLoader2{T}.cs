...
namespace ComputeSharp.Shaders.Translation
{
        ...
        where T : struct, IComputeShader
    {
        ...
        /// <summary>
        /// Creates a new <see cref="ShaderLoader2{T}"/> instance.
        /// </summary>
        private ShaderLoader2()
        {
        }
        ...
        [Pure]
        public static ShaderLoader2<T> Load(in T shader)
        {
            ShaderLoader2<T> @this = new ShaderLoader2<T>();
