...
{
    /// <inheritdoc/>
    public partial class AutoConstructorGenerator
    {
        /// <summary>
        ...
        private sealed class SyntaxReceiver : ISyntaxContextReceiver
        {
            ...
            {
                if (context.Node is StructDeclarationSyntax { AttributeLists: { Count: > 0 } } structDeclarations &&
                    context.SemanticModel.GetDeclaredSymbol(structDeclarations) is INamedTypeSymbol structSymbol &&
                ...
                {
                    this.gatheredInfo.Add(new Item(structDeclarations, structSymbol, attributeSyntax, attributeData));
                }
            }
            ...
            /// </summary>
            /// <param name="StructDeclaration">The <see cref="StructDeclarationSyntax"/> instance for the target class declaration.</param>
