...
public sealed partial class IShaderGenerator2
{
    ...
    private static DispatchMetadataInfo GetDispatchMetadataInfo(
    ...
    private static MethodDeclarationSyntax CreateLoadDispatchMetadataMethod(DispatchMetadataInfo metadataInfo)
    {
