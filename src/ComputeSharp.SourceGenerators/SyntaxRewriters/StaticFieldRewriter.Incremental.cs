...
/// </summary>
internal sealed class StaticFieldRewriter2 : HlslSourceRewriter2
{
    /// <summary>
    /// Creates a new <see cref="StaticFieldRewriter2"/> instance with the specified parameters.
    /// </summary>
