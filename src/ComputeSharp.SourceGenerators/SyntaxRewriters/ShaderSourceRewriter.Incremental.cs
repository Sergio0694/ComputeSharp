...
/// </summary>
internal sealed class ShaderSourceRewriter2 : HlslSourceRewriter2
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new <see cref="ShaderSourceRewriter2"/> instance with the specified parameters.
    /// </summary>
    ...
    public override SyntaxNode? VisitInvocationExpression(InvocationExpressionSyntax node)
    {
            ...
            method.IsStatic)
        {
            ...
            if (!SymbolEqualityComparer.Default.Equals(this.shaderType, method.ContainingType))
            {
                ...
                {
                    ShaderSourceRewriter2 ShaderSourceRewriter2 = new(SemanticModel, DiscoveredTypes, this.staticMethods, ConstantDefinitions, Diagnostics);
                    MethodDeclarationSyntax methodNode = (MethodDeclarationSyntax)method.DeclaringSyntaxReferences[0].GetSyntax();
                    MethodDeclarationSyntax processedMethod = ShaderSourceRewriter2.Visit(methodNode)!.NormalizeWhitespace(eol: "\n").WithoutTrivia();
