...
/// </summary>
internal abstract class ExecuteMethodRewriter2 : CSharpSyntaxRewriter
{
    /// <summary>
    /// Creates a new <see cref="Compute"/> instance with the specified parameters.
    /// </summary>
    /// <param name="shaderSourceRewriter">The <see cref="ShaderSourceRewriter2"/> instance used to process the input tree.</param>
    public ExecuteMethodRewriter2(ShaderSourceRewriter2 shaderSourceRewriter)
    {
        ShaderSourceRewriter2 = shaderSourceRewriter;
    }

    /// <summary>
    /// Gets the <see cref="ShaderSourceRewriter2"/> instance used to process the input tree.
    /// </summary>
    protected ShaderSourceRewriter2 ShaderSourceRewriter2 { get; }
    ...
    /// </summary>
    public sealed class Compute : ExecuteMethodRewriter2
    {
        /// <summary>
        /// Creates a new <see cref="Compute"/> instance with the specified parameters.
        /// </summary>
        /// <param name="shaderSourceRewriter">The <see cref="ShaderSourceRewriter2"/> instance used to process the input tree.</param>
        public Compute(ShaderSourceRewriter2 shaderSourceRewriter)
    ...
    /// A custom <see cref="ExecuteMethodRewriter"/> type specialized for compute shaders.
    /// </summary>
    public sealed class Pixel : ExecuteMethodRewriter2
    {
        /// <summary>
        /// Creates a new <see cref="Pixel"/> instance with the specified parameters.
        /// </summary>
        /// <param name="shaderSourceRewriter">The <see cref="ShaderSourceRewriter2"/> instance used to process the input tree.</param>
        public Pixel(ShaderSourceRewriter2 shaderSourceRewriter)
            : base(shaderSourceRewriter)
        {
        }
