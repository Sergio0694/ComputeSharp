...
public sealed partial class IShaderGenerator2
{
    ...
    private static ThreadIdsInfo GetThreadIdsForEmbeddedShader(
    ...
    [Pure]
    private static unsafe ImmutableArray<byte> GetShaderBytecode(
    ...
    private static MethodDeclarationSyntax CreateTryGetBytecodeMethod(EmbeddedBytecodeInfo bytecodeInfo, out Func<SyntaxNode, string> fixup)
    {
