...
partial class ReadWriteTexture3D<T, TPixel>
{
    ...
    /// </summary>
    private sealed unsafe class ReadOnly : ReferenceTracker.ITrackedObject, IDisposable, IReadOnlyNormalizedTexture3D<TPixel>, GraphicsResourceHelper.IGraphicsResource
    {
        /// <summary>
