...
namespace ComputeSharp
{
    ...
    public partial struct Int4
    {
        ...
        public static Int4 operator +(Int4 left, Int4 right) => throw new InvalidExecutionContextException($"{typeof(Int4)}.+");
