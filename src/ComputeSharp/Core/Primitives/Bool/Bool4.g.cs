...
namespace ComputeSharp
{
    ...
    public partial struct Bool4
    {
        ...
        /// </summary>
        public ref Bool2 XZ => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(XZ)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="X"/>, <see cref="W"/>.
        /// </summary>
        public ref Bool2 XW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(XW)}");
        ...
        /// </summary>
        public ref Bool2 YZ => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(YZ)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="Y"/>, <see cref="W"/>.
        /// </summary>
        public ref Bool2 YW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(YW)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="Z"/>, <see cref="X"/>.
        /// </summary>
        public ref Bool2 ZX => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(ZX)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="Z"/>, <see cref="Y"/>.
        /// </summary>
        public ref Bool2 ZY => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(ZY)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool2"/> value with the components <see cref="Z"/>, <see cref="Z"/>.
        /// </summary>
        public ref readonly Bool2 ZZ => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(ZZ)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="Z"/>, <see cref="W"/>.
        /// </summary>
        public ref Bool2 ZW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(ZW)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="W"/>, <see cref="X"/>.
        /// </summary>
        public ref Bool2 WX => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(WX)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="W"/>, <see cref="Y"/>.
        /// </summary>
        public ref Bool2 WY => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(WY)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="W"/>, <see cref="Z"/>.
        /// </summary>
        public ref Bool2 WZ => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(WZ)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool2"/> value with the components <see cref="W"/>, <see cref="W"/>.
        /// </summary>
        public ref readonly Bool2 WW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(WW)}");
        ...
        /// </summary>
        public ref readonly Bool3 XXW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(XXW)}");
        ...
        /// </summary>
        public ref Bool3 XYW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(XYW)}");
        ...
        /// </summary>
        public ref Bool3 XZW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(XZW)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool3"/> value with the components <see cref="X"/>, <see cref="W"/>, <see cref="X"/>.
        /// </summary>
        public ref readonly Bool3 XWX => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(XWX)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool3"/> value with the components <see cref="X"/>, <see cref="W"/>, <see cref="Y"/>.
        /// </summary>
        public ref Bool3 XWY => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(XWY)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool3"/> value with the components <see cref="X"/>, <see cref="W"/>, <see cref="Z"/>.
        /// </summary>
        public ref Bool3 XWZ => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(XWZ)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool3"/> value with the components <see cref="X"/>, <see cref="W"/>, <see cref="W"/>.
        /// </summary>
        public ref readonly Bool3 XWW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(XWW)}");
        ...
        /// </summary>
        public ref Bool3 YXW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(YXW)}");
        ...
        /// </summary>
        public ref readonly Bool3 YYW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(YYW)}");
        ...
        /// </summary>
        public ref Bool3 YZW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(YZW)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool3"/> value with the components <see cref="Y"/>, <see cref="W"/>, <see cref="X"/>.
        /// </summary>
        public ref Bool3 YWX => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(YWX)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool3"/> value with the components <see cref="Y"/>, <see cref="W"/>, <see cref="Y"/>.
        /// </summary>
        public ref readonly Bool3 YWY => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(YWY)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool3"/> value with the components <see cref="Y"/>, <see cref="W"/>, <see cref="Z"/>.
        /// </summary>
        public ref Bool3 YWZ => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(YWZ)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool3"/> value with the components <see cref="Y"/>, <see cref="W"/>, <see cref="W"/>.
        /// </summary>
        public ref readonly Bool3 YWW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(YWW)}");
        ...
        /// </summary>
        public ref Bool3 ZXW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(ZXW)}");
        ...
        /// </summary>
        public ref Bool3 ZYW => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(ZYW)}");
        ...
        /// </summary>
        public ref Bool2 RB => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(RB)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="R"/>, <see cref="A"/>.
        /// </summary>
        public ref Bool2 RA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(RA)}");
        ...
        /// </summary>
        public ref Bool2 GB => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(GB)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="G"/>, <see cref="A"/>.
        /// </summary>
        public ref Bool2 GA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(GA)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="B"/>, <see cref="R"/>.
        /// </summary>
        public ref Bool2 BR => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(BR)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="B"/>, <see cref="G"/>.
        /// </summary>
        public ref Bool2 BG => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(BG)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool2"/> value with the components <see cref="B"/>, <see cref="B"/>.
        /// </summary>
        public ref readonly Bool2 BB => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(BB)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="B"/>, <see cref="A"/>.
        /// </summary>
        public ref Bool2 BA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(BA)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="A"/>, <see cref="R"/>.
        /// </summary>
        public ref Bool2 AR => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(AR)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="A"/>, <see cref="G"/>.
        /// </summary>
        public ref Bool2 AG => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(AG)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool2"/> value with the components <see cref="A"/>, <see cref="B"/>.
        /// </summary>
        public ref Bool2 AB => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(AB)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool2"/> value with the components <see cref="A"/>, <see cref="A"/>.
        /// </summary>
        public ref readonly Bool2 AA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(AA)}");
        ...
        /// </summary>
        public ref readonly Bool3 RRA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(RRA)}");
        ...
        /// </summary>
        public ref Bool3 RGA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(RGA)}");
        ...
        /// </summary>
        public ref Bool3 RBA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(RBA)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool3"/> value with the components <see cref="R"/>, <see cref="A"/>, <see cref="R"/>.
        /// </summary>
        public ref readonly Bool3 RAR => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(RAR)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool3"/> value with the components <see cref="R"/>, <see cref="A"/>, <see cref="G"/>.
        /// </summary>
        public ref Bool3 RAG => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(RAG)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool3"/> value with the components <see cref="R"/>, <see cref="A"/>, <see cref="B"/>.
        /// </summary>
        public ref Bool3 RAB => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(RAB)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool3"/> value with the components <see cref="R"/>, <see cref="A"/>, <see cref="A"/>.
        /// </summary>
        public ref readonly Bool3 RAA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(RAA)}");
        ...
        /// </summary>
        public ref Bool3 GRA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(GRA)}");
        ...
        /// </summary>
        public ref readonly Bool3 GGA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(GGA)}");
        ...
        /// </summary>
        public ref Bool3 GBA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(GBA)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool3"/> value with the components <see cref="G"/>, <see cref="A"/>, <see cref="R"/>.
        /// </summary>
        public ref Bool3 GAR => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(GAR)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool3"/> value with the components <see cref="G"/>, <see cref="A"/>, <see cref="G"/>.
        /// </summary>
        public ref readonly Bool3 GAG => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(GAG)}");

        /// <summary>
        /// Gets a reference to the <see cref="Bool3"/> value with the components <see cref="G"/>, <see cref="A"/>, <see cref="B"/>.
        /// </summary>
        public ref Bool3 GAB => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(GAB)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="Bool3"/> value with the components <see cref="G"/>, <see cref="A"/>, <see cref="A"/>.
        /// </summary>
        public ref readonly Bool3 GAA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(GAA)}");
        ...
        /// </summary>
        public ref Bool3 BRA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(BRA)}");
        ...
        /// </summary>
        public ref Bool3 BGA => throw new InvalidExecutionContextException($"{nameof(Bool4)}.{nameof(BGA)}");
