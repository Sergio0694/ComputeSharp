...
partial class CanvasEffect
{
    ...
    /// </summary>
    protected readonly ref struct CanvasEffectGraph
    {
        /// <summary>
        ...
        /// <remarks>
        /// This method can only be called from an <see cref="CanvasEffectGraph"/> value being passed to <see cref="BuildEffectGraph"/>. If this
    ...
    /// </para>
    /// </remarks>
    protected interface ICanvasEffectNode;
    ...
    /// </para>
    /// </remarks>
    protected interface ICanvasEffectNode<out T> : ICanvasEffectNode
    ...
    protected sealed class CanvasEffectNode<T> : ICanvasEffectNode<T>
        where T : class, ICanvasImage;
}