...
unsafe partial struct PassthroughEffect
{
    ...
    private static class ID2D1EffectImplMethods
    {
        ...
        public delegate int QueryInterfaceDelegate(PassthroughEffect* @this, Guid* riid, void** ppvObject);

        /// <inheritdoc cref="AddRef"/>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate uint AddRefDelegate(PassthroughEffect* @this);

        /// <inheritdoc cref="Release"/>
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate uint ReleaseDelegate(PassthroughEffect* @this);
