...
namespace ComputeSharp
{
    ...
    public partial struct UInt4
    {
        ...
        /// </summary>
        public ref UInt2 XZ => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(XZ)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="X"/>, <see cref="W"/>.
        /// </summary>
        public ref UInt2 XW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(XW)}");
        ...
        /// </summary>
        public ref UInt2 YZ => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(YZ)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="Y"/>, <see cref="W"/>.
        /// </summary>
        public ref UInt2 YW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(YW)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="Z"/>, <see cref="X"/>.
        /// </summary>
        public ref UInt2 ZX => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(ZX)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="Z"/>, <see cref="Y"/>.
        /// </summary>
        public ref UInt2 ZY => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(ZY)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt2"/> value with the components <see cref="Z"/>, <see cref="Z"/>.
        /// </summary>
        public ref readonly UInt2 ZZ => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(ZZ)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="Z"/>, <see cref="W"/>.
        /// </summary>
        public ref UInt2 ZW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(ZW)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="W"/>, <see cref="X"/>.
        /// </summary>
        public ref UInt2 WX => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(WX)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="W"/>, <see cref="Y"/>.
        /// </summary>
        public ref UInt2 WY => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(WY)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="W"/>, <see cref="Z"/>.
        /// </summary>
        public ref UInt2 WZ => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(WZ)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt2"/> value with the components <see cref="W"/>, <see cref="W"/>.
        /// </summary>
        public ref readonly UInt2 WW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(WW)}");
        ...
        /// </summary>
        public ref readonly UInt3 XXW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(XXW)}");
        ...
        /// </summary>
        public ref UInt3 XYW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(XYW)}");
        ...
        /// </summary>
        public ref UInt3 XZW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(XZW)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt3"/> value with the components <see cref="X"/>, <see cref="W"/>, <see cref="X"/>.
        /// </summary>
        public ref readonly UInt3 XWX => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(XWX)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt3"/> value with the components <see cref="X"/>, <see cref="W"/>, <see cref="Y"/>.
        /// </summary>
        public ref UInt3 XWY => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(XWY)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt3"/> value with the components <see cref="X"/>, <see cref="W"/>, <see cref="Z"/>.
        /// </summary>
        public ref UInt3 XWZ => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(XWZ)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt3"/> value with the components <see cref="X"/>, <see cref="W"/>, <see cref="W"/>.
        /// </summary>
        public ref readonly UInt3 XWW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(XWW)}");
        ...
        /// </summary>
        public ref UInt3 YXW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(YXW)}");
        ...
        /// </summary>
        public ref readonly UInt3 YYW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(YYW)}");
        ...
        /// </summary>
        public ref UInt3 YZW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(YZW)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt3"/> value with the components <see cref="Y"/>, <see cref="W"/>, <see cref="X"/>.
        /// </summary>
        public ref UInt3 YWX => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(YWX)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt3"/> value with the components <see cref="Y"/>, <see cref="W"/>, <see cref="Y"/>.
        /// </summary>
        public ref readonly UInt3 YWY => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(YWY)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt3"/> value with the components <see cref="Y"/>, <see cref="W"/>, <see cref="Z"/>.
        /// </summary>
        public ref UInt3 YWZ => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(YWZ)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt3"/> value with the components <see cref="Y"/>, <see cref="W"/>, <see cref="W"/>.
        /// </summary>
        public ref readonly UInt3 YWW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(YWW)}");
        ...
        /// </summary>
        public ref UInt3 ZXW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(ZXW)}");
        ...
        /// </summary>
        public ref UInt3 ZYW => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(ZYW)}");
        ...
        /// </summary>
        public ref UInt2 RB => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(RB)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="R"/>, <see cref="A"/>.
        /// </summary>
        public ref UInt2 RA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(RA)}");
        ...
        /// </summary>
        public ref UInt2 GB => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(GB)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="G"/>, <see cref="A"/>.
        /// </summary>
        public ref UInt2 GA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(GA)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="B"/>, <see cref="R"/>.
        /// </summary>
        public ref UInt2 BR => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(BR)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="B"/>, <see cref="G"/>.
        /// </summary>
        public ref UInt2 BG => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(BG)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt2"/> value with the components <see cref="B"/>, <see cref="B"/>.
        /// </summary>
        public ref readonly UInt2 BB => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(BB)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="B"/>, <see cref="A"/>.
        /// </summary>
        public ref UInt2 BA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(BA)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="A"/>, <see cref="R"/>.
        /// </summary>
        public ref UInt2 AR => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(AR)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="A"/>, <see cref="G"/>.
        /// </summary>
        public ref UInt2 AG => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(AG)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt2"/> value with the components <see cref="A"/>, <see cref="B"/>.
        /// </summary>
        public ref UInt2 AB => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(AB)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt2"/> value with the components <see cref="A"/>, <see cref="A"/>.
        /// </summary>
        public ref readonly UInt2 AA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(AA)}");
        ...
        /// </summary>
        public ref readonly UInt3 RRA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(RRA)}");
        ...
        /// </summary>
        public ref UInt3 RGA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(RGA)}");
        ...
        /// </summary>
        public ref UInt3 RBA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(RBA)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt3"/> value with the components <see cref="R"/>, <see cref="A"/>, <see cref="R"/>.
        /// </summary>
        public ref readonly UInt3 RAR => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(RAR)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt3"/> value with the components <see cref="R"/>, <see cref="A"/>, <see cref="G"/>.
        /// </summary>
        public ref UInt3 RAG => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(RAG)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt3"/> value with the components <see cref="R"/>, <see cref="A"/>, <see cref="B"/>.
        /// </summary>
        public ref UInt3 RAB => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(RAB)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt3"/> value with the components <see cref="R"/>, <see cref="A"/>, <see cref="A"/>.
        /// </summary>
        public ref readonly UInt3 RAA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(RAA)}");
        ...
        /// </summary>
        public ref UInt3 GRA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(GRA)}");
        ...
        /// </summary>
        public ref readonly UInt3 GGA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(GGA)}");
        ...
        /// </summary>
        public ref UInt3 GBA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(GBA)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt3"/> value with the components <see cref="G"/>, <see cref="A"/>, <see cref="R"/>.
        /// </summary>
        public ref UInt3 GAR => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(GAR)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt3"/> value with the components <see cref="G"/>, <see cref="A"/>, <see cref="G"/>.
        /// </summary>
        public ref readonly UInt3 GAG => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(GAG)}");

        /// <summary>
        /// Gets a reference to the <see cref="UInt3"/> value with the components <see cref="G"/>, <see cref="A"/>, <see cref="B"/>.
        /// </summary>
        public ref UInt3 GAB => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(GAB)}");

        /// <summary>
        /// Gets a readonly reference to the <see cref="UInt3"/> value with the components <see cref="G"/>, <see cref="A"/>, <see cref="A"/>.
        /// </summary>
        public ref readonly UInt3 GAA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(GAA)}");
        ...
        /// </summary>
        public ref UInt3 BRA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(BRA)}");
        ...
        /// </summary>
        public ref UInt3 BGA => throw new InvalidExecutionContextException($"{nameof(UInt4)}.{nameof(BGA)}");
