...
namespace ComputeSharp
{
    ...
    public partial struct Bool3
    {
        ...
        public Bool2 XX
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(XX)}");
        }
        ...
        public Bool2 YY
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(YY)}");
        }
        ...
        public Bool2 RR
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(RR)}");
        }
        ...
        public Bool2 GG
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(GG)}");
        }
        ...
        public Bool3 XXX
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(XXX)}");
        }
        ...
        public Bool3 XXY
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(XXY)}");
        }
        ...
        public Bool3 XXZ
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(XXZ)}");
        }
        ...
        public Bool3 XYX
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(XYX)}");
        }
        ...
        public Bool3 XYY
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(XYY)}");
        }
        ...
        public Bool3 XZX
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(XZX)}");
        }
        ...
        public Bool3 XZZ
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(XZZ)}");
        }
        ...
        public Bool3 YXX
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(YXX)}");
        }
        ...
        public Bool3 YXY
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(YXY)}");
        }
        ...
        public Bool3 YYX
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(YYX)}");
        }
        ...
        public Bool3 YYY
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(YYY)}");
        }
        ...
        public Bool3 YYZ
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(YYZ)}");
        }
        ...
        public Bool3 YZY
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(YZY)}");
        }
        ...
        public Bool3 YZZ
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(YZZ)}");
        }
        ...
        public Bool3 ZXX
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(ZXX)}");
        }
        ...
        public Bool3 ZXZ
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(ZXZ)}");
        }
        ...
        public Bool3 ZYY
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(ZYY)}");
        }
        ...
        public Bool3 ZYZ
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(ZYZ)}");
        }
        ...
        public Bool3 ZZX
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(ZZX)}");
        }
        ...
        public Bool3 ZZY
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(ZZY)}");
        }
        ...
        public Bool3 ZZZ
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(ZZZ)}");
        }
        ...
        public Bool3 RRR
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(RRR)}");
        }
        ...
        public Bool3 RRG
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(RRG)}");
        }
        ...
        public Bool3 RRB
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(RRB)}");
        }
        ...
        public Bool3 RGR
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(RGR)}");
        }
        ...
        public Bool3 RGG
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(RGG)}");
        }
        ...
        public Bool3 RBR
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(RBR)}");
        }
        ...
        public Bool3 RBB
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(RBB)}");
        }
        ...
        public Bool3 GRR
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(GRR)}");
        }
        ...
        public Bool3 GRG
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(GRG)}");
        }
        ...
        public Bool3 GGR
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(GGR)}");
        }
        ...
        public Bool3 GGG
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(GGG)}");
        }
        ...
        public Bool3 GGB
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(GGB)}");
        }
        ...
        public Bool3 GBG
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(GBG)}");
        }
        ...
        public Bool3 GBB
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(GBB)}");
        }
        ...
        public Bool3 BRR
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(BRR)}");
        }
        ...
        public Bool3 BRB
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(BRB)}");
        }
        ...
        public Bool3 BGG
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(BGG)}");
        }
        ...
        public Bool3 BGB
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(BGB)}");
        }
        ...
        public Bool3 BBR
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(BBR)}");
        }
        ...
        public Bool3 BBG
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(BBG)}");
        }
        ...
        public Bool3 BBB
        {
            get => throw new InvalidExecutionContextException($"{nameof(Bool3)}.{nameof(BBB)}");
        }
    }
}
