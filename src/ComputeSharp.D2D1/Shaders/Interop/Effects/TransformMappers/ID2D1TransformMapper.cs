...
internal unsafe struct ID2D1TransformMapper
{
    ...
    /// </summary>
    /// <param name="updateContext">The input <see cref="ID2D1RenderInfoUpdateContext"/> instance.</param>
    ...
    public HRESULT MapInputRectsToOutputRect(
        ID2D1RenderInfoUpdateContext* updateContext,
        RECT* inputRects,
    ...
    {
        return ((delegate* unmanaged[Stdcall]<ID2D1TransformMapper*, ID2D1RenderInfoUpdateContext*, RECT*, RECT*, uint, RECT*, RECT*, int>)this.lpVtbl[3])(
