...
/// <summary>
/// A base type to support non-generic <see cref="D2D1TransformMapper{T}"/> uses.
/// </summary>
internal unsafe interface ID2D1TransformMapperInterop
{
    /// <inheritdoc cref="D2D1TransformMapper{T}.MapInputsToOutput"/>
    ...
    /// <inheritdoc cref="D2D1TransformMapper{T}.MapOutputToInputs"/>
    void MapOutputToInputs(in Rectangle output, Span<Rectangle> inputs);

    /// <inheritdoc cref="D2D1TransformMapper{T}.MapInvalidOutput"/>
