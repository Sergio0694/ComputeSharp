...
unsafe partial struct ComputeShaderEffect
{
    ...
    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager0"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager0Wrapper = GetResourceTextureManager0Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager0"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager0Wrapper = SetResourceTextureManager0Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager1"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager1Wrapper = GetResourceTextureManager1Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager1"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager1Wrapper = SetResourceTextureManager1Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager2"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager2Wrapper = GetResourceTextureManager2Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager2"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager2Wrapper = SetResourceTextureManager2Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager3"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager3Wrapper = GetResourceTextureManager3Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager3"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager3Wrapper = SetResourceTextureManager3Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager4"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager4Wrapper = GetResourceTextureManager4Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager4"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager4Wrapper = SetResourceTextureManager4Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager5"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager5Wrapper = GetResourceTextureManager5Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager5"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager5Wrapper = SetResourceTextureManager5Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager6"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager6Wrapper = GetResourceTextureManager6Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager6"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager6Wrapper = SetResourceTextureManager6Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager7"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager7Wrapper = GetResourceTextureManager7Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager7"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager7Wrapper = SetResourceTextureManager7Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager8"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager8Wrapper = GetResourceTextureManager8Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager8"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager8Wrapper = SetResourceTextureManager8Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager9"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager9Wrapper = GetResourceTextureManager9Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager9"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager9Wrapper = SetResourceTextureManager9Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager10"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager10Wrapper = GetResourceTextureManager10Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager10"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager10Wrapper = SetResourceTextureManager10Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager11"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager11Wrapper = GetResourceTextureManager11Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager11"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager11Wrapper = SetResourceTextureManager11Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager12"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager12Wrapper = GetResourceTextureManager12Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager12"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager12Wrapper = SetResourceTextureManager12Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager13"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager13Wrapper = GetResourceTextureManager13Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager13"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager13Wrapper = SetResourceTextureManager13Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager14"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager14Wrapper = GetResourceTextureManager14Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager14"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager14Wrapper = SetResourceTextureManager14Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertyGetFunctionDelegate"/> instance wrapping <see cref="GetResourceTextureManager15"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertyGetFunctionDelegate GetResourceTextureManager15Wrapper = GetResourceTextureManager15Impl;

    /// <summary>
    /// A cached <see cref="PixelShaderEffect.PropertySetFunctionDelegate"/> instance wrapping <see cref="SetResourceTextureManager15"/>.
    /// </summary>
    private static readonly PixelShaderEffect.PropertySetFunctionDelegate SetResourceTextureManager15Wrapper = SetResourceTextureManager15Impl;
#endif
